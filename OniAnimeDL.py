...
class AnimeWrapper:
    def __init__(self):
        self.search_link="https://www1.gogoanime.ai//search.html?keyword={}"
        self.anime_movie="https://www1.gogoanime.ai/anime-movies.html?aph=&page={}"
    ...
    def download(self,anime_id,episode):
        ...
        if (response["status"]==200):
            content=BeautifulSoup(response["content"].decode(sys.stdout.encoding,errors='replace'),"html.parser")
            dlpage_response=start_loop.run_until_complete(self.get_response("https://www1.gogoanime.ai/{}-episode-{}".format(anime_id.replace("/category/",""),episode)))
...
"background-color: rgb(35, 35, 35);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_5.setText(_translate("MainWindow", "Made by : Kanao#1365"))
